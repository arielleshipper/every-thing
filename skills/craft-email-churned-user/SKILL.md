---
name: "craft-email-churned-user"
description: "Use when working on Churned User Email. This skill produces win-back emails for two distinct lapsed-user populations, which behave differently and require different treatment:"
---
